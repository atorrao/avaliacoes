...
const statusBadge: Record<string, 'green'|'gray'|'blue'> = { active: 'green', completed: 'blue', archived: 'gray' }
...
export default function Portfolios() {
  ...
  return (
    <div>
      ...
      />
      <div className="p-6">
        {isLoading ? <p className="text-sm text-gray-400">A carregar…</p> : portfolios.length === 0
